...
(40, 'Gary', 'Wright', 'Marketing', 87000.00, '2021-01-10', 29, NULL, 'UK');
 ...
 /* ==========================
   LESSON 5 - SQL PRACTICE
   ========================== */

/* EASY LEVEL */

/* 1. Alias ProductName as Name */
...
/* 3. UNION – combine Products and Products_Discounted */
...
/* 4. INTERSECT – products present in both tables */
SELECT ProductName FROM Products
INTERSECT
SELECT ProductName FROM Products_Discounted;
...
/* 5. DISTINCT – customer names and their countries */
...
/* 6. CASE – if Price > 1000 then High, else Low */
SELECT ProductName,
       Price,
       CASE 
...
/* 7. IIF – if StockQuantity > 100 then Yes, else No */
SELECT ProductName,
       StockQuantity,
...
/* 8. UNION – combine product names from both tables */
SELECT ProductName FROM Products
UNION
SELECT ProductName FROM Products_Discounted;
...
/* 9. EXCEPT – products in Products but not in Products_Discounted */
SELECT ProductName FROM Products
EXCEPT
SELECT ProductName FROM Products_Discounted;
...
/* 10. IIF – if Price > 1000 then Expensive, else Affordable */
SELECT ProductName,
       Price,
...
/* 12. Employees – increase salary by 10% for HR or EmployeeID = 5 */
UPDATE Employees
...
/* 13. Sales – categorize SaleAmount using CASE */
SELECT SaleID,
       SaleAmount,
       CASE
...
/* 14. EXCEPT – customers in Orders but not in Sales */
...
/* 15. CASE – calculate discount based on Quantity */
SELECT CustomerID,
       Quantity,
       CASE
           WHEN Quantity = 1 THEN '3%'
           WHEN Quantity BETWEEN 2 AND 3 THEN '5%'
           WHEN Quantity >= 4 THEN '7%'
